...
import getSocietes, { UpdateSociete } from '@/services/societe';
...
const UpdateSocietes =  ({closeDialog, setSocietes, societe}:{closeDialog:any, setSocietes:any, societe:Societe}) => {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      try {
        //@ts-ignore
        values.roles = [{name : values.role}]
        await  UpdateSociete(societe.idsociete, values)
