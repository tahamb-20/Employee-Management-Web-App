...
const AddPresence = ({closeDialog, setPresences, usersCommand}:{closeDialog:any, setPresences:any, usersCommand:any}) => {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
       ...
       try {
        ...
        values.user = user._id
         await   PresenceService.addPresenceAndAssignToEmployee(values)
